...
// // E dance
// static td_tap_t e_dance_tap_state = {.state = TD_NONE};
// // A dance
// static td_tap_t a_dance_tap_state = {.state = TD_NONE};
// // U dance
// static td_tap_t u_dance_tap_state = {.state = TD_NONE};
// // C dance
// static td_tap_t c_dance_tap_state = {.state = TD_NONE};

// void e_dance_reset(qk_tap_dance_state_t *state, void *user_data) {
//     switch (e_dance_tap_state.state) {
//         case TD_SINGLE_HOLD:
//         case TD_DOUBLE_HOLD:
...
//             break;
//     }
//     e_dance_tap_state.state = TD_NONE;
// }

// void e_dance_finished(qk_tap_dance_state_t *state, void *user_data) {
//     e_dance_tap_state.state = complex_dance(state);
//     switch (e_dance_tap_state.state) {
//         case TD_SINGLE_TAP:
//             // e
//             tap_code16(KC_E);
...
// void a_dance_reset(qk_tap_dance_state_t *state, void *user_data) {
//     switch (a_dance_tap_state.state) {
//         case TD_DOUBLE_HOLD:
...
//     a_dance_tap_state.state = TD_NONE;
// }

// void a_dance_finished(qk_tap_dance_state_t *state, void *user_data) {
//     a_dance_tap_state.state = complex_dance(state);
//     switch (a_dance_tap_state.state) {
//         case TD_SINGLE_TAP:
//             // a
//             tap_code16(KC_A);
...
// void u_dance_reset(qk_tap_dance_state_t *state, void *user_data) {
//     switch (u_dance_tap_state.state) {
//         case TD_DOUBLE_HOLD:
...
//             break;
//     }
//     u_dance_tap_state.state = TD_NONE;
// }

// void u_dance_finished(qk_tap_dance_state_t *state, void *user_data) {
//     u_dance_tap_state.state = complex_dance(state);
//     switch (u_dance_tap_state.state) {
//         case TD_SINGLE_TAP:
//             // u
//             tap_code16(KC_U);
...
// void c_dance_reset(qk_tap_dance_state_t *state, void *user_data) {
//     switch (c_dance_tap_state.state) {
//         case TD_DOUBLE_HOLD:
...
//             break;
//     }
//     c_dance_tap_state.state = TD_NONE;
// }

// void c_dance_finished(qk_tap_dance_state_t *state, void *user_data) {
//     c_dance_tap_state.state = complex_dance(state);
//     switch (c_dance_tap_state.state) {
//         case TD_SINGLE_TAP:
//             // c
//             tap_code16(KC_C);
...
//     [TD_E] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, e_dance_finished, e_dance_reset),
//     [TD_A] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, a_dance_finished, a_dance_reset),
//     [TD_U] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, u_dance_finished, u_dance_reset),
//     [TD_C] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, c_dance_finished, c_dance_reset)
// };
// clang-format on
// #endif
